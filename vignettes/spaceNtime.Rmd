...
Users with timelapse data may have occasion-by-occasion information about the camera's area and functionality. This information would be collected while analyzing the photos. For instance, a photo with the lens covered in snow could be coded as area = 0. If this information was collected, the user has the option of creating the object deploy directly from df. 
```{r, echo = F}
df1 <- data.frame(
  cam = c(1,1,2,2,2),
  datetime = as.POSIXct(c("2016-01-02 12:00:00",
...
This version of deploy should contain *every* photo taken during the study period. It will have the following columns, at a minimum:
