...
With one simple step, you can build your space-to-event encounter history. There will be NAs on every occasion where no animals were detected. NAs will be treated as right-censors in the model. 
